...
public class Airplane extends FlyingObject {
     ...
     * toString method
     * 
     * @return String with the airplane attributes and class. For any children
     *         classes it displays their class instead.
     */
    ...
    /**
     * Equals method that compares the attributes of the calling object and passed
     * object to return true or false if all their attributes
     * are equal.
     * 
     * @return True if all attributes are the same between passed object and calling
     *         object. False if the passed object is null or if it
